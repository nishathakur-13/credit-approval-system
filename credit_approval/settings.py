...
# CSRF Trusted Origins (Crucial for form submissions on Render)
...
INSTALLED_APPS = [
    ...
    'django.contrib.messages',  # Required for success/error messages
...
MIDDLEWARE = [
    ...
    'django.middleware.csrf.CsrfViewMiddleware', # Security for your registration form
